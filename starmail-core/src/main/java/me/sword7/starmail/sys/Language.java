...
public enum Language {
    ...
    TEXT_BLACKLIST_ADD_NAME("Text - blacklist add name", "add the held item's NAME to the blacklist*"),
    TEXT_BLACKLIST_ADD_TYPE("Text - blacklist add type", "add the held item's TYPE to the blacklist*"),
    TEXT_BLACKLIST_ADD_DESCRIPTION("Text - blacklist add description", "add the held item's DESCRIPTION to the blacklist*"),
    TEXT_BLACKLIST_HELP("Text - blacklist help", "show the blacklist help"),
    TEXT_BLACKLIST_LIST("Text - blacklist list", "show the codes in the blacklist"),
    TEXT_BLACKLIST_REMOVE_NAME("Text - blacklist remove name", "remove the held item's NAME to the blacklist*"),
    TEXT_BLACKLIST_REMOVE_TYPE("Text - blacklist remove type", "remove the held item's TYPE to the blacklist*"),
    TEXT_BLACKLIST_REMOVE_DESCRIPTION("Text - blacklist remove description", "remove the held item's DESCRIPTION to the blacklist*"),
    TEXT_BLACKLIST_RELOAD("Text - blacklist reload", "reload the in-game configuration lists, to match the file one"),
    TEXT_BLACKLIST_EXPLAIN_PIPE("Text - blacklist pipe operator", "You can add up the add or remove operations to include more than one attribute to check with the pipe '|' operator, eg:\n'/blacklist add name|type|description' or '/blacklist remove name|description' etc..."),
    TEXT_BLACKLIST_EXPLAIN_ASTERISK("Text - blacklist add asterisk", "*you may want specify the HASH keyword to encrypt, or remove the encrypted, data"),
